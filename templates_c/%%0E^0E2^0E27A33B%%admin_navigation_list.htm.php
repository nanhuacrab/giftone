...
"  name='del[]' onclick='unselectall()' rel="del_chk" /></td>
        ...
        <td class="td"><?php if ($this->_tpl_vars['v']['type'] == '1'): ?>站内链接<?php else: ?>原链接<?php endif; ?></td>
...
" class="admin_cz_bj">修改</a> | <a href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=navigation&c=del&id=<?php echo $this->_tpl_vars['v']['id']; ?>
