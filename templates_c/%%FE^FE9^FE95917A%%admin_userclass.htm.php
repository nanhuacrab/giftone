<?php /* Smarty version 2.6.26, created on 2015-01-29 18:21:06
...
<span class="admin_title_span">个人会员分类</span>
 <a  href="javascript:void(0)" onClick="add_class('个人会员分类','300','200','#wname','index.php?m=userclass&c=save')" class="admin_infoboxp_tj">添加类别</a>
</div>
...
" name='del[]' onclick='unselectall()' rel="del_chk" /></td>
		...
		<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;┗<span onClick="checkname('<?php echo $this->_tpl_vars['v']['id']; ?>
');" id="name<?php echo $this->_tpl_vars['v']['id']; ?>
" style="cursor:pointer;"><?php echo $this->_tpl_vars['v']['name']; ?>
</span>
        <input class="input-text hidden" type="text" id="inputname<?php echo $this->_tpl_vars['v']['id']; ?>
