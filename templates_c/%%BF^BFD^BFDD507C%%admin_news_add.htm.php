...
">字体颜色</font><input type="button" id="colorpicker" value="打开取色器" class="admin_submit6" style="background:#F60; margin-left:5px;"/></td>
     ...
     <input type="button" value="<?php if ($this->_tpl_vars['news']['domain_name'] == ""): ?>全站<?php else: ?><?php echo $this->_tpl_vars['news']['domain_name']; ?>
...
<span class="all_Domain_name_box_list"><input type="checkbox" class="domain" id="did" value="0+0" <?php if (stripos ( $this->_tpl_vars['news']['did'] , '0' ) !== false): ?>checked<?php endif; ?> class="all_Domain_name_box_bth"> 全站</span> 
