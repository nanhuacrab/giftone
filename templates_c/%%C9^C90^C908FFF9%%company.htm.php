<?php /* Smarty version 2.6.26, created on 2015-02-01 04:17:27
         compiled from default/register/company.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'default/register/company.htm', 28, false),)), $this); ?>
  ...
  <div class="logoin_cont fl">
    <div class="reg_h1_tit">
      <ul class="reg_ul_list">
        <li onclick="checkreg(1)" id="reg1" class="reg_cur"><a class="reg_h1_icon"><i class="reg_h1_icon_i reg_h1_icon_i3 png"></i>企业注册</a></li>
...
/about/service.html" target="_blank" class="reg_yhxy"> 《用户服务协议》</a> ，并自愿遵守该协议。
     ...
     <li class="reg_re"><em>&nbsp;</em>
       ...
       <div class="kg_lgn_psw_txt">密码强度:弱</div>
		...
		<?php endif; ?>
		<?php if ($this->_tpl_vars['config']['reg_comemail'] == '1'): ?>
		...
		<?php endif; ?>
		<?php if ($this->_tpl_vars['config']['reg_comlink'] == '1'): ?>
     <li class="mt20"><em><font color="#FF0000">*</font> 联系人：</em>
     <input type="text" id="linkman" class="logoin_text tips_class" onBlur="reg_checkAjax('linkman');">
     <span class="reg_tips reg_tips_red" id="ajax_linkman" style="display:none;"></span>
     </li>
	  <?php endif; ?>
	   <?php if ($this->_tpl_vars['config']['reg_comtel'] == '1'): ?>
     <li class="mt20"><em><font color="#FF0000">*</font> 联系手机：</em>
     <input type="text" id="linkphone" class="logoin_text tips_class" onBlur="reg_checkAjax('linkphone');">
     <span class="reg_tips reg_tips_red" id="ajax_linkphone" style="display:none;"></span>
     </li>
	  <?php endif; ?>
	<?php if ($this->_tpl_vars['config']['reg_comname'] == '1'): ?>
     ...
     <span class="reg_tips reg_tips_red" id="ajax_unit_name" style="display:none;"></span>
     </li>
	 <?php endif; ?>
	  
	 <?php if ($this->_tpl_vars['config']['reg_comaddress'] == '1'): ?>
     ...
     <span class="reg_tips reg_tips_red" id="ajax_address" style="display:none;"></span>
     </li>
	  <?php endif; ?>
        <?php if (strpos ( $this->_tpl_vars['config']['code_web'] , "注册会员" ) !== false): ?>
         <li class="m10"><em><font color="#FF0000">*</font> 验证码：</em>
...
/about/service.html" target="_blank" class="reg_yhxy"> 《用户服务协议》</a> ，并自愿遵守该协议。
    ...
    <div class="register_right">
      <div class="register_right_c"> 已有企业账号 ? <a href="<?php echo smarty_function_url(array('m' => 'login','url' => "usertype:2"), $this);?>
">立即登录</a></div>
