<?php /* Smarty version 2.6.26, created on 2015-02-01 04:13:14
         compiled from default/index/wap.htm */ ?>
...
">
<link rel="stylesheet" href="<?php echo $this->_tpl_vars['client']; ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => ($this->_tpl_vars['tplstyle'])."/client_header.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<div class="wap_banner fl">
  <div class="wap_banner_img touch_banner touch_banner_wap">
    <div class="wap_iphoto"><img src="<?php echo $this->_tpl_vars['client']; ?>
/images/yun_job_wap1.png" class="png"></div>
    <div class="banner_biaoyu"><img src="<?php echo $this->_tpl_vars['client']; ?>
/images/yun_job_wap2.png" class="png"></div>
    <div class="banner_input fr"><?php echo $this->_tpl_vars['config']['sy_weburl']; ?>
/wap</div>
    <div class="wap_erweim_bg png"></div>
    <div class="wap_erweim"><img src="<?php echo $this->_tpl_vars['client']; ?>
/images/yun_appcom.png" class="png"></div>
  </div>
</div>
  ...
  <div class="w980">
    <div class="touch fl">
      <div class="touch_size fl">
        <dl>
          <dt><img src="<?php echo $this->_tpl_vars['client']; ?>
...
/images/touch_items_04.gif"></dt>
  ...
  <div class="index_list fl">
    <div class="index_list_one touch_h330 touch_bg fl">
      <div class="w980">
        <div class="index_phone fr"><img src="<?php echo $this->_tpl_vars['client']; ?>
...
/images/tach_text01.gif"></dt>
    ...
    <div class="index_list_one touch_h330 fl">
      <div class="w980">
        <div class="index_phone fl"><img src="<?php echo $this->_tpl_vars['client']; ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => ($this->_tpl_vars['tplstyle'])."/client_footer.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>