<?php /* Smarty version 2.6.26, created on 2015-01-29 21:28:03
         compiled from admin/apply.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'seacrh_url', 'admin/apply.htm', 56, false),array('function', 'url', 'admin/apply.htm', 83, false),array('function', 'curl', 'admin/apply.htm', 84, false),array('modifier', 'date_format', 'admin/apply.htm', 88, false),)), $this); ?>
...
<div class="infoboxp"><div class="infoboxp_top_bg"></div>
  <div class="admin_Filter">
    <span class="complay_top_span fl">职位申请记录</span> 
      <form action="index.php" name="myform" method="get">
        <input name="m" value="apply" type="hidden"/>
        <span class="admin_Filter_span">检索类型：</span> 
		<div class="admin_Filter_text formselect"  did='dtype'>
		  <input type="button" value="<?php if ($_GET['type'] == '1' || $_GET['type'] == ''): ?>职位名称<?php elseif ($_GET['type'] == '2'): ?>公司名称<?php elseif ($_GET['type'] == '3'): ?>个人用户名<?php else: ?>简历名称<?php endif; ?>" class="admin_Filter_but"  id="btype">
        ...
        <table width="100%">
          <thead>
            <tr class="admin_table_top">
			  ...
			  <a href="<?php echo seacrh_url(array('order' => 'desc','t' => 'id','m' => 'apply','untype' => "order,t"), $this);?>
">编号<img src="images/sanj.jpg"/></a>
              <?php else: ?>
              <a href="<?php echo seacrh_url(array('order' => 'asc','t' => 'id','m' => 'apply','untype' => "order,t"), $this);?>
">编号<img src="images/sanj2.jpg"/></a>
			  ...
			  <a href="<?php echo seacrh_url(array('order' => 'desc','t' => 'datetime','m' => 'apply','untype' => "order,t"), $this);?>
">申请时间<img src="images/sanj.jpg"/></a>
              <?php else: ?>
              <a href="<?php echo seacrh_url(array('order' => 'asc','t' => 'datetime','m' => 'apply','untype' => "order,t"), $this);?>
...
"  name='del[]' onclick='unselectall()' rel="del_chk" /></td>
            ...
            <td class="ud" align="left"><a href="<?php echo smarty_function_url(array('m' => 'com','url' => "c:comapply,id:".($this->_tpl_vars['v']['job_id'])), $this);?>
" target="_blank"><?php echo $this->_tpl_vars['v']['job_name']; ?>
</a></td>
            <td class="ud" align="left"><a href="<?php echo smarty_function_curl(array('url' => "id:".($this->_tpl_vars['v']['com_id'])), $this);?>
" target="_blank"><?php echo $this->_tpl_vars['v']['com_name']; ?>
</a></td>
            <td class="ud" align="left"><a href="<?php echo smarty_function_url(array('m' => 'resume','url' => "id:".($this->_tpl_vars['v']['eid'])), $this);?>
" target="_blank"><?php echo $this->_tpl_vars['v']['resume']; ?>
</a></td>
            <td class="td" align="left"><a href="index.php?m=user_member&c=edit&id=<?php echo $this->_tpl_vars['v']['uid']; ?>
" target="_blank"><?php echo $this->_tpl_vars['v']['username']; ?>
</a></td>
            <td class="td" align="center"><?php if ($this->_tpl_vars['v']['is_browse'] == 2): ?>已查看<?php else: ?>未查看<?php endif; ?></td>
            ...
            <td><a href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=apply&c=del&del=<?php echo $this->_tpl_vars['v']['id']; ?>
