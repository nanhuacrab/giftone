<?php /* Smarty version 2.6.26, created on 2015-02-01 14:37:29
         compiled from admin/admin_emailmsg.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'seacrh_url', 'admin/admin_emailmsg.htm', 52, false),array('modifier', 'date_format', 'admin/admin_emailmsg.htm', 74, false),)), $this); ?>
...
"/>
      ...
      <div class="admin_Filter_text formselect" did="dtype">
        <input type="button" <?php if ($_GET['type'] == '' || $_GET['type'] == '1'): ?> value="邮箱"<?php elseif ($_GET['type'] == '2'): ?> value="发送人" <?php elseif ($_GET['type'] == '3'): ?> value="接收人"<?php endif; ?> class="admin_Filter_but" id="btype">
        ...
        <table width="100%">
          <thead>
            <tr class="admin_table_top">
              ...
              <th align="left"> <?php if ($_GET['t'] == 'id' && $_GET['order'] == 'asc'): ?> <a href="<?php echo seacrh_url(array('order' => 'desc','t' => 'id','m' => 'emailmsg','untype' => "order,t"), $this);?>
">编号<img src="images/sanj.jpg"/></a> <?php else: ?> <a href="<?php echo seacrh_url(array('order' => 'asc','t' => 'id','m' => 'emailmsg','untype' => "order,t"), $this);?>
">编号<img src="images/sanj2.jpg"/></a> <?php endif; ?> </th>
              ...
              <th align="left">标题</th>
              <!--th align="left">内容</th-->
              <th> <?php if ($_GET['t'] == 'ctime' && $_GET['order'] == 'asc'): ?> <a href="<?php echo seacrh_url(array('order' => 'desc','t' => 'ctime','m' => 'emailmsg','untype' => "order,t"), $this);?>
">时间<img src="images/sanj.jpg"/></a> <?php else: ?> <a href="<?php echo seacrh_url(array('order' => 'asc','t' => 'ctime','m' => 'emailmsg','untype' => "order,t"), $this);?>
...
<?php else: ?>系统<?php endif; ?></td>
            ...
            <td><?php echo ((is_array($_tmp=$this->_tpl_vars['v']['ctime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d %H:%M") : smarty_modifier_date_format($_tmp, "%Y-%m-%d %H:%M")); ?>
</td>
            <td><?php if ($this->_tpl_vars['v']['state'] == 1): ?><font color="green">成功</font><?php else: ?><font color="red">失败</font><?php endif; ?></td>
            <td><a href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=emailmsg&c=del&id=<?php echo $this->_tpl_vars['v']['id']; ?>
