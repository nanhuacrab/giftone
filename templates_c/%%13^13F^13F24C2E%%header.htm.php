<?php /* Smarty version 2.6.26, created on 2015-01-29 18:17:51
         compiled from E:%5Chtdocs%5Cgift11/template/default/header.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'E:\\htdocs\\gift11/template/default/header.htm', 6, false),)), $this); ?>
<div class="top">
  <div class="top_cot">
...
" <?php if ($this->_tpl_vars['navlist']['eject']): ?> target="_blank"<?php endif; ?> class="png"> <?php echo $this->_tpl_vars['navlist']['name']; ?>
 </a>
            <div class="nav_icon"> <?php if ($this->_tpl_vars['navlist']['model'] == 'new'): ?> <img src="<?php echo $this->_tpl_vars['style']; ?>
/images/new.gif"> <?php elseif ($this->_tpl_vars['navlist']['model'] == 'hot'): ?> <img src="<?php echo $this->_tpl_vars['style']; ?>
/images/hotn.gif"> <?php endif; ?></div>
          </li>
          <?php endforeach; endif; unset($_from); ?>
        </ul>
      </div>
...
?> <?php if ($this->_tpl_vars['key'] != 0): ?><span class="nav_right_span">|</span><?php endif; ?> <a href="<?php echo $this->_tpl_vars['nav']['url']; ?>
...
;<?php endif; ?><?php if ($this->_tpl_vars['nav']['bold'] == 1): ?>font-weight:bolder;<?php endif; ?>"><?php echo $this->_tpl_vars['nav']['name']; ?>
            ...
            <div class="nav_icon"> <?php if ($this->_tpl_vars['nav']['model'] == 'new'): ?> <img src="<?php echo $this->_tpl_vars['style']; ?>
/images/new.gif"> <?php elseif ($this->_tpl_vars['nav']['model'] == 'hot'): ?> <img src="<?php echo $this->_tpl_vars['style']; ?>
/images/hotn.gif"> <?php endif; ?></div> 
            </a> <?php endforeach; endif; unset($_from); ?> </div>
        </div>
      </div>
