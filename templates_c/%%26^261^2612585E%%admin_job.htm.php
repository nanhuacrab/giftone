<?php /* Smarty version 2.6.26, created on 2015-01-29 18:21:10
...
<span class="admin_title_span">职位类别管理</span>
<a href="index.php?m=admin_job&c=classadd" class="admin_infoboxp_tj">添加类别</a>
</div>
...
');" class="admin_cz_sc">删除</a>
	...
	<tr align="center" id="list<?php echo $this->_tpl_vars['onejob']['id']; ?>
">
...
?>
	...
	<tr align="center" id="list<?php echo $this->_tpl_vars['two']['id']; ?>
">
...
?>
	...
	<tr align="center" id="list<?php echo $this->_tpl_vars['three']['id']; ?>
">
...
');">移动</a> | <a href="index.php?m=admin_job&c=classadd&id=<?php echo $this->_tpl_vars['three']['id']; ?>
">修改</a></td>
	</tr>
