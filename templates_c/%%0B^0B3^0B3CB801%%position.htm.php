<?php /* Smarty version 2.6.26, created on 2015-01-30 22:28:28
         compiled from company/default/position.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'company/default/position.htm', 26, false),)), $this); ?>
...
<script src="<?php echo $this->_tpl_vars['config']['sy_weburl']; ?>
/js/map.js" language="javascript"></script>
</head>
<body>
...
unset($_smarty_tpl_vars);
 ...
 <div class="Job_Introduction_cont">
     ...
     <?php if ($this->_tpl_vars['com']['y'] != '' && $this->_tpl_vars['com']['x'] != ''): ?>
       <div id="map_container" style="width:100%;height:350px;"></div>
   <script>
  getmapshowcont('map_container',"<?php echo $this->_tpl_vars['com']['x']; ?>
","<?php echo $this->_tpl_vars['com']['y']; ?>
","<?php echo $this->_tpl_vars['com']['name']; ?>
","<?php echo $this->_tpl_vars['com']['address']; ?>
");
  </script>
  <?php else: ?>
<div class="comapply_no_msg"> <div class="comapply_no_msg_cont"><span></span><em>该公司还没有标注地理位置!</em></div></div>
<?php endif; ?>
</div>
</div></div></div>
