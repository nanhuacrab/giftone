<?php /* Smarty version 2.6.26, created on 2015-01-29 18:24:51
         compiled from default/news/index.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'default/news/index.htm', 69, false),array('modifier', 'count', 'default/news/index.htm', 81, false),array('modifier', 'date_format', 'default/news/index.htm', 97, false),)), $this); ?>
...
<div class="news_Slideshow fl">
	<?php $_from = $this->_tpl_vars['news_flash']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['news_flash']):
?> 
	<input name="picurl" id="<?php echo $this->_tpl_vars['key']+1; ?>
" type="hidden" value="<?php echo $this->_tpl_vars['news_flash']['newsphoto']; ?>
+<?php echo $this->_tpl_vars['news_flash']['url']; ?>
+<?php echo $this->_tpl_vars['news_flash']['title']; ?>
" />	 
...
" target="_blank"><?php echo $this->_tpl_vars['arclistright']['title']; ?>
</a>
