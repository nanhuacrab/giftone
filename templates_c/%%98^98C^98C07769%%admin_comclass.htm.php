<?php /* Smarty version 2.6.26, created on 2015-01-29 18:21:09
...
<span class="admin_title_span">企业会员分类管理</span>
<a  href="javascript:void(0)" onClick="add_class('企业会员分类','300','200','#wname','index.php?m=comclass&c=save')" class="admin_infoboxp_tj">添加类别</a>
</div>
...
<?php endif; ?>
	...
	<tr align="center" id="list<?php echo $this->_tpl_vars['class1']['id']; ?>
">
