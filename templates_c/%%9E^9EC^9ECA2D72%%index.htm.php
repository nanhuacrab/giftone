...
smarty_core_load_plugins(array('plugins' => array(array('function', 'wapurl', 'wap/index.htm', 23, false),array('modifier', 'mb_substr', 'wap/index.htm', 24, false),)), $this); ?>
...
<header  class="index_post_hot_h1"><a href="javascript:;">热门搜索</a></header>
<table class="ht">
<tbody>
<tr>
...
<aside><?php echo ((is_array($_tmp=$this->_tpl_vars['job']['com_name'])) ? $this->_run_mod_handler('mb_substr', true, $_tmp, 0, 12, 'gbk') : mb_substr($_tmp, 0, 12, 'gbk')); ?>
</aside>
